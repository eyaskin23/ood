...
/**
 * Creates a test class of offers to make sure
...
public class OffersTests {
  ...
  public void testValidFullTimeJobConstruction() {
    Offer fullTime = new FullTimeJob("Software Dev", 1000, new ArrayList<>());
  ...
  public void satisfiesCoop() {
    Offer coopOffer = new Coop("Startup Co-op", 26, 40, List.of(new Ability("OOD"), new Years(1)));
    List<Skill> qualifiedApplicant = List.of(new Ability("OOD"), new Years(2));
